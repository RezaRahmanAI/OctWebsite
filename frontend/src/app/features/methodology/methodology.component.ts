...
type MatrixKey = 'team-augmentation' | 'mvp-development' | 'end-to-end-development' | 'offshore-development';
...
export class MethodologyComponent {
  readonly heroHighlights: StatHighlight[] = [
  ...
  readonly featureMatrix: MatrixFeature[] = [
    {
    ...
    },
    {
      ...
      appliesTo: ['team-augmentation', 'mvp-development', 'end-to-end-development']
    },
    {
      name: 'Expand Your Team Quickly',
      appliesTo: ['team-augmentation', 'offshore-development']
    },
    {
      name: 'Prototype Your Ideas',
      appliesTo: ['mvp-development']
    },
    {
      name: 'Complete End-to-End Development',
      appliesTo: ['end-to-end-development']
    },
    {
      name: 'Ensure Product Scalability',
      appliesTo: ['end-to-end-development', 'mvp-development']
    },
    {
  ...
  readonly offerings: Offering[] = [
      ...
      benefits: [
        {
          ...
          description:
            "We've already done the rigorous testing for technical, logical, and soft-skill abilities so you don't have to worry at all."
        },
        {
          title: 'Smooth Communication',
          description: 'Streamlined touchpoints ensure efficient information flow and seamless collaboration.'
        },
        {
          title: 'Quick Recruitment Process',
          description: 'Our efficient recruitment process assembles the perfect team of experts for your project without delays.'
        },
        {
          title: 'Seamless Integration',
          description: 'Talents align together effortlessly, creating a symphony of efficiency and innovation.'
        }
      ],
      process: [
        { title: 'Schedule a Call', description: 'Share your talent requirements and team size for tailored augmentation.' },
        { title: 'Contract Signing', description: 'Confirm scope and SLAs for your IT staff augmentation.' },
        { title: 'Talent Allocation', description: 'Receive ready-to-go teams aligned to your stack and ceremonies.' },
        { title: 'Project Continues', description: 'Augmented teams sync with in-house squads to ensure on-time delivery.' }
      ],
      closing: {
      ...
      benefits: [
        {
          ...
          description: 'Launch your product quickly, gain user feedback, and validate early.'
        },
    ...
    },
    {
      ...
      benefits: [
        ...
        {
          title: 'Smooth Communication',
          description: 'Efficient information flow and seamless collaboration across the lifecycle.'
        },
        {
          title: 'Skip Recruitment Process',
          description: 'On-demand expert teams with years of experience mean you avoid hiring overhead.'
        },
        {
          title: 'Cost-Efficient',
          description: 'A cohesive build process reduces rework and drives long-term savings.'
        }
      ],
      process: [
      ...
      benefits: [
        {
          ...
          description: 'Tap into a diverse pool of skilled professionals matched to every project.'
        },
        {
          title: 'Cost Savings and Efficiency',
          description: 'Enjoy affordable offshore office expansion while maintaining high-quality standards.'
        },
        {
          title: 'Scalability and Flexibility',
          description: 'Scale with your project requirements without the hassle of hiring and firing.'
        },
        {
          title: '24/7 Operations',
          description: 'Teams in different time zones keep work moving and accelerate turnaround times.'
        }
      ],
      process: [
  ...
  readonly contactFields = ['Your name', 'Company name', 'Business mail', 'Phone number', 'About the project'];
}
